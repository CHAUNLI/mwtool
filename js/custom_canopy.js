...
xmlCusCanopy.open('GET', "http://www.mwtoolboxqld.com.au/testphpapp/myphp/custom_canopy", true);
...
function colCreate(){
    ...
    var col=document.getElementById('custom_canopies').appendChild(divCol);
    return col;
};
...
function muskCreate(img_model,index_id){
    ...
    muskDiv.id=index_id;
    muskDiv.setAttribute('onclick','clickCustomToolboxEvent('+index_id+')');
