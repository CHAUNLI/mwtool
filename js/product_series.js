...
trayhttp.open('POST', "http://localhost/mwtool/testphpapp/myphp/products/series_tray", true);
trayhttp.setRequestHeader("Accept", "application/json");
trayhttp.send();

powerhttp.open('POST', "http://localhost/mwtool/testphpapp/myphp/products/series_coated", true);
